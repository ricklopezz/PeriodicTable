...
INSERT INTO public.elements VALUES (999, 'Xx', 'TestElement');
...
INSERT INTO public.properties VALUES (999, 0.01, -1, -1, 3);
...
--
-- Name: properties properties_type_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_type_fk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
